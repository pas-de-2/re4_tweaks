...
void ReadSettingsIni(std::wstring ini_path)
{
	...
	// Main .ini file
	{
		...
		re4t::cfg->bRevertWiiKnifeBuff = ini.getBool("GAMEPLAY", "RevertWiiKnifeBuff", re4t::cfg->bRevertWiiKnifeBuff);
		re4t::cfg->bDisableAdaKnife = ini.getBool("GAMEPLAY", "DisableAdaKnife", re4t::cfg->bDisableAdaKnife);
		re4t::cfg->bNAGameCubeBalance = ini.getBool("GAMEPLAY", "NAGameCubeBalance", re4t::cfg->bNAGameCubeBalance);
...
void re4t_cfg::WriteSettings(bool trainerOnly)
{
	...
	if (!trainerOnly)
	{
		...
		ini.setBool("GAMEPLAY", "RevertWiiKnifeBuff", re4t::cfg->bRevertWiiKnifeBuff);
		ini.setBool("GAMEPLAY", "DisableAdaKnife", re4t::cfg->bDisableAdaKnife);
		ini.setBool("GAMEPLAY", "NAGameCubeBalance", re4t::cfg->bNAGameCubeBalance);
