...
; Reduces the length of menu fades/messages (eg. 'Load/Save successful!') and skips the initial "Resident Evil 4" logo / "PRESS ANY KEY" screen, letting you load straight into the main menu.
